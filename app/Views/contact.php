...
<div class="isolate  px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        ...
        <?php if (isset($_SESSION['success'])): ?>
            <p class="text-green-600 mb-4 text-center"><?php echo htmlspecialchars($_SESSION['success']); ?></p>
        <?php unset($_SESSION['success']);
        endif; ?>

        <!-- Hiển thị thông báo lỗi -->
        <?php if (isset($_SESSION['error_contact'])): ?>
            <p class="text-red-500 mb-4 text-center"><?php echo htmlspecialchars($_SESSION['error_contact']); ?></p>
        <?php unset($_SESSION['error_contact']);
        endif; ?>
